  ...
  return (
    <section id="contact" className="py-20 bg-white">
      <div className="container-section">
        <h2 className="section-title pb-4">Contacto</h2>
        <p className="text-center text-xl text-gray-600 max-w-2xl mx-auto mb-12">
          Estamos aquí para responder tus preguntas. Contacta con nosotros y te atenderemos a la brevedad.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="animate-fade-in">
            <div className="bg-dental-light p-8 rounded-lg shadow-md h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="bg-gold-light p-3 rounded-full mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@drivanabril.com" className="text-gray-600 hover:text-gold transition-colors">
                      info@drivanabril.com
                    </a>
                    <p className="text-sm text-gray-500 mt-1">Siempre disponible para ti</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <h4 className="text-lg font-medium text-gray-800 mb-4">Síguenos</h4>
                <div className="flex space-x-4">
                  <a href="#" className="bg-gold text-white p-2 rounded-full hover:bg-gold-dark transition-colors">
